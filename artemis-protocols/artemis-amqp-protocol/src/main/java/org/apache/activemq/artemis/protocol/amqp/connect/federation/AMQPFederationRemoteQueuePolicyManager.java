...
/**
 * Policy manager that manages state data for remote AMQP Federation Queue policies and their
...
public final class AMQPFederationRemoteQueuePolicyManager extends AMQPFederationRemotePolicyManager {
   ...
   /**
    * Name used when the remote queue policy name is not present due to having connected to an
