...
/**
 * Management service control instance for an AMQPFederation instance that federates messages
 * from the remote broker on the opposing side of this broker connection.
 */
