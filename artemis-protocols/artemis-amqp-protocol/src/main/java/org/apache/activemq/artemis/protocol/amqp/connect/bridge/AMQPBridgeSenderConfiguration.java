...
public final class AMQPBridgeSenderConfiguration extends AMQPBridgeLinkConfiguration {
   ...
   /**
    * {@return <code>true</code> if bridge is configured to auto delete address senders that durable subscription bindings}
    */
    ...
    */
   public long getAutoDeleteDuableSubscriptionMsgCount() {
      ...
      if (property instanceof Number) {
         ...
         return configuration.getAutoDeleteDuableSubscriptionMsgCount();
      }
   }
    ...
    */
   public long getAutoDeleteDuableSubscriptionDelay() {
      ...
      if (property instanceof Number) {
         ...
         return configuration.getAutoDeleteDuableSubscriptionDelay();
      }
   }
}
