...
public class HQPropertiesConverter {
   ...
   static {
      ...
      d.put(SimpleString.toSimpleString("_HQ_ACTUAL_EXPIRY"), SimpleString.toSimpleString("_AMQ_ACTUAL_EXPIRY"));
      d.put(SimpleString.toSimpleString("_HQ_ORIG_ADDRESS"), SimpleString.toSimpleString("_AMQ_ORIG_ADDRESS"));
      d.put(SimpleString.toSimpleString("_HQ_ORIG_QUEUE"), SimpleString.toSimpleString("_AMQ_ORIG_QUEUE"));
      d.put(SimpleString.toSimpleString("_HQ_ORIG_MESSAGE_ID"), SimpleString.toSimpleString("_AMQ_ORIG_MESSAGE_ID"));
      d.put(SimpleString.toSimpleString("_HQ_GROUP_ID"), SimpleString.toSimpleString("_AMQ_GROUP_ID"));
      d.put(SimpleString.toSimpleString("_HQ_LARGE_COMPRESSED"), SimpleString.toSimpleString("_AMQ_LARGE_COMPRESSED"));
      d.put(SimpleString.toSimpleString("_HQ_LARGE_SIZE"), SimpleString.toSimpleString("_AMQ_LARGE_SIZE"));
      d.put(SimpleString.toSimpleString("_HQ_SCHED_DELIVERY"), SimpleString.toSimpleString("_AMQ_SCHED_DELIVERY"));
      d.put(SimpleString.toSimpleString("_HQ_DUPL_ID"), SimpleString.toSimpleString("_AMQ_DUPL_ID"));
      d.put(SimpleString.toSimpleString("_HQ_LVQ_NAME"), SimpleString.toSimpleString("_AMQ_LVQ_NAME"));
