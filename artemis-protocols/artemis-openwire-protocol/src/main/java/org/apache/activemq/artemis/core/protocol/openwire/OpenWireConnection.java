...
public class OpenWireConnection implements RemotingConnection, CommandVisitor {
   ...
   public Response processAddConnection(ConnectionInfo info) throws Exception {
      ...
      synchronized (brokerConnectionStates) {
         state = (AMQTransportConnectionState) brokerConnectionStates.get(info.getConnectionId());
         if (state == null) {
   ...
   protected synchronized AMQTransportConnectionState registerConnectionState(ConnectionId connectionId,
   ...
   public Response processRemoveConnection(ConnectionId id, long lastDeliveredSequenceId) throws Exception {
      ...
      if (cs != null) {
         ...
         try {
            protocolManager.removeConnection(cs.getContext(), cs.getInfo(), null);
         }
         catch (Throwable e) {
            // log
         }
