 ...
 */
@Deprecated
public class EmbeddedJMSDelegate {
    ...
    * Create a default EmbeddedJMSResource
    */
   public EmbeddedJMSDelegate(boolean useNetty) {
      try {
    ...
    */
   public EmbeddedJMSDelegate(int serverId) {
    ...
    */
   public EmbeddedJMSDelegate(Configuration configuration, JMSConfiguration jmsConfiguration) {
    ...
    */
   public EmbeddedJMSDelegate(String filename) {
    ...
    */
   public EmbeddedJMSDelegate(String serverConfigurationFileName, String jmsConfigurationFileName) {
