 ...
 * </code></pre>
 */
public class EmbeddedActiveMQDelegate {
    ...
    */
   public EmbeddedActiveMQDelegate() {
    ...
    */
   public EmbeddedActiveMQDelegate(int serverId) {
    ...
    */
   public EmbeddedActiveMQDelegate(Configuration configuration) {
    ...
    */
   public EmbeddedActiveMQDelegate(String filename) {
      if (filename == null) {
