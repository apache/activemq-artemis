...
public class ActiveMQProducerDelegate extends AbstractActiveMQClientDelegate {
   ...
   public ActiveMQProducerDelegate(String url, String address, String username, String password) {
      this(url, SimpleString.toSimpleString(address), username, password);
   }

   public ActiveMQProducerDelegate(String url, String address) {
      this(url, address, null, null);
   }

   public ActiveMQProducerDelegate(String url, SimpleString address, String username, String password) {
      super(url, username, password);
      if (address == null) {
   ...
   public ActiveMQProducerDelegate(String url, SimpleString address) {
      this(url, address, null, null);
   }

   public ActiveMQProducerDelegate(ServerLocator serverLocator, String address, String username, String password) {
      this(serverLocator, SimpleString.toSimpleString(address), username, password);
   }

   public ActiveMQProducerDelegate(ServerLocator serverLocator, String address) {
      this(serverLocator, SimpleString.toSimpleString(address));
   }

   public ActiveMQProducerDelegate(ServerLocator serverLocator, SimpleString address, String username, String password) {
      super(serverLocator, username, password);
      if (address == null) {
         throw new IllegalArgumentException(String.format("%s construction error - address cannot be null", this.getClass().getSimpleName()));
      }
   ...
   public ActiveMQProducerDelegate(ServerLocator serverLocator, SimpleString address) {
