...
If the vote fails then you'll need to revert the two commits from the Maven release process and delete the tag so the issues with the release can be fixed and the release can be re-tagged.
