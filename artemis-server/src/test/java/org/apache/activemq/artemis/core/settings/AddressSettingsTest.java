...
public class AddressSettingsTest extends ServerTestBase {
   ...
   private void testSingleMerge(boolean copy) {
      ...
      addressSettingsToMerge.setIntermediateMessageBufferInitialSize(256);
      ...
      assertEquals(Integer.valueOf(256), addressSettings.getIntermediateMessageBufferInitialSize());
   }
