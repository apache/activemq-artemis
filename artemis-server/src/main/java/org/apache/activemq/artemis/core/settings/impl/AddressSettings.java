...
public class AddressSettings implements Mergeable<AddressSettings>, Serializable, EncodingSupport {
   ...
   static {
      metaBean.add(Integer.class, "intermediateMessageBufferInitialSize", (t, p) -> t.intermediateMessageBufferInitialSize = p, t -> t.intermediateMessageBufferInitialSize);
   }
   private Integer intermediateMessageBufferInitialSize = null;
   ...
   public AddressSettings setIntermediateMessageBufferInitialSize(int intermediateMessageBufferInitialSize) {
      this.intermediateMessageBufferInitialSize = intermediateMessageBufferInitialSize;
      return this;
   }
