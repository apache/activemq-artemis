 ...
 * available is used.
 */
public class AnyNodeLocatorForScaleDown extends NodeLocator {
   ...
   public AnyNodeLocatorForScaleDown(ActiveMQServerImpl server) {
      super();
      this.server = server;
   ...
   public void nodeUP(TopologyMember topologyMember, boolean last) {
      try {
         ...
         if (server.checkBrokerIsNotColocated(topologyMember.getNodeId())) {
