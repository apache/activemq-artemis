...
public class PostOfficeImpl implements PostOffice, NotificationListener, BindingsFactory {
   ...
   private final class AddressQueueReaper extends ActiveMQScheduledComponent {
      ...
      public void run() {
         for (Queue queue : getLocalQueues()) {
            if (!queue.isInternalQueue() && queue.isUsed() && QueueManagerImpl.isAutoDelete(queue) && QueueManagerImpl.consumerCountCheck(queue) && QueueManagerImpl.delayCheck(queue) && QueueManagerImpl.messageCountCheck(queue)) {
