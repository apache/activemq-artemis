...
public final class DescribeJournal {
   ...
   public static DescribeJournal describeMessagesJournal(final File messagesDir, PrintStream out, boolean safe) throws Exception {
      ...
      JournalImpl messagesJournal = new JournalImpl(CONFIGURATION.getJournalFileSize(), defaultValues.getJournalMinFiles(), defaultValues.getJournalPoolFiles(), 0, 0, messagesFF, "activemq-data", "amq", 1);
