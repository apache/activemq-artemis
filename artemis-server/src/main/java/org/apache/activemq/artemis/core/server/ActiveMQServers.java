 ...
 * <p>
 * This class should be used when you want to instantiate an ActiveMQServer instance for embedding in your own
 * application, as opposed to directly instantiating an implementing instance.
 */
