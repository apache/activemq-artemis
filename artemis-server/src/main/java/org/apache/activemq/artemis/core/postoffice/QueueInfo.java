...
public class QueueInfo implements Serializable {
   ...
   private AtomicInteger numberOfConsumers = new AtomicInteger(0);
   ...
   public int getNumberOfConsumers() {
      return numberOfConsumers.get();
   }

   public void incrementConsumers() {
      numberOfConsumers.incrementAndGet();
   }

   public void decrementConsumers() {
      numberOfConsumers.getAndUpdate(value -> {
         if (value > 0) {
            return value--;
         } else {
