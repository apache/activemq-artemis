...
-   We used to distribute libartemis-native-32.so until early 2017. While it's not available on the distribution it should still be possible to compile to a 32 bits environment if needed.
