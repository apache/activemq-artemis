...
- `message-load-balancing`. This parameter determines if/how
  ...
  It can be one of five values - `OFF`, `OFF_WITH_REDISTRIBUTION`,
  ...
  If this is set to `OFF_WITH_REDISTRIBUTION` then the behavior is the
...
`OFF_WITH_REDISTRIBUTION` or `STRICT_WITH_REDISTRIBUTION`.
