...
public class ExclusiveQueueClientSideExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try (Connection connection = connectionFactory.createConnection()) {
            ...
            System.out.println(ExclusiveQueueClientSideExample.class.getName() +
                    " 'consumer1' received 20 messages as expected");
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (consumer2Message == null) {
                    throw new RuntimeException("Example FAILED - 'consumer2' should have received 10 messages" +
                            "after consumer1 has been closed");
                }
            }

            System.out.println(ExclusiveQueueClientSideExample.class.getName() + " 'consumer2' received 10 messages " +
                    "as expected, after 'consumer1' has been closed");
            ...
            System.out.println(ExclusiveQueueClientSideExample.class.getName() + " 'consumer3' received 0 messages " +
                    "as expected");
