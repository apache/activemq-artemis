...
public class ClientSideLoadBalancingExample extends HornetQExample
{
   ...
   public boolean runExample() throws Exception
   {
      ...
      try
      {
         ...
         System.out.println("Session A - " + ((org.apache.activemq6.core.client.impl.DelegatingSession) ((org.hornetq.jms.client.HornetQSession) sessionA).getCoreSession()).getConnection().getRemoteAddress() );
         System.out.println("Session B - " + ((org.apache.activemq6.core.client.impl.DelegatingSession) ((org.hornetq.jms.client.HornetQSession) sessionB).getCoreSession()).getConnection().getRemoteAddress() );
         System.out.println("Session C - " + ((org.apache.activemq6.core.client.impl.DelegatingSession) ((org.hornetq.jms.client.HornetQSession) sessionC).getCoreSession()).getConnection().getRemoteAddress() );
