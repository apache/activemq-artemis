   ...
   class JmsConsumerDup implements MessageListener {
      ...
      public void onMessage(Message message) {
         ...
         try {
            ...
            if (count % 100 == 0) {
               LOG.info("Rcvd Msg #-" + count + " " + m.getText() + " Sent->" + dtf.format(new Date(m.getJMSTimestamp())) + " Recv->" + dtf.format(new Date()) + " Expr->" + dtf.format(new Date(m.getJMSExpiration())) + ", mid: " + m.getJMSMessageID());
            }
