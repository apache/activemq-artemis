...
public class DurableSubProcessWithRestartTest {
   ...
   public static final Random CLIENT_LIFETIME = new Random(5 * 1000, 2 * 5 * 1000);
   ...
   @Ignore("covered by org.apache.activemq.usecases.DurableSubscriptionOfflineTest.testNoMissOnMatchingSubAfterRestart()")
   @Test
   ...
   private enum ClientType {
      ...
      public static ClientType randomClientType() {
         return values()[DurableSubProcessWithRestartTest.random(values().length - 1)];
      }

      public final String randomMessageType() {
         return messageTypes[DurableSubProcessWithRestartTest.random(messageTypes.length - 1)];
      }
