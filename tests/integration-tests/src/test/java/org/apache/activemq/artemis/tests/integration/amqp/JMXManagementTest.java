...
public class JMXManagementTest extends JMSClientTestSupport {
   ...
   public void testGetFirstMessageWithAMQPTypes() throws Exception {
      ...
      try {
         ...
         Assert.assertNotNull(firstMessageObject.getJsonNumber("TEST_DECIMAL_64").doubleValue());
         Assert.assertNotNull(firstMessageObject.getJsonNumber("TEST_DECIMAL_128").doubleValue());
      } finally {
         connection.close();
      }
   }
