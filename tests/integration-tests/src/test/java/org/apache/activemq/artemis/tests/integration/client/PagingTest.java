               ...
               public void run()
               {
                  try
                  {
                     ...
                     for (int i = 0; i < numberOfMessages; i++)
                     {
                        ...
                        {
                           PagingTest.log.info("Expected buffer:" + ActiveMQTestBase.dumbBytesHex(body, 40));
                           PagingTest.log.info("Arriving buffer:" + ActiveMQTestBase.dumbBytesHex(message2.getBodyBuffer()
                                                                                                          .toByteBuffer()
                                                                                                          .array(), 40));
                           throw e;
                        }
