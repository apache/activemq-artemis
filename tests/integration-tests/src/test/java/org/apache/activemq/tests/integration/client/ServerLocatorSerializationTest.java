...
public class ServerLocatorSerializationTest extends ServiceTestBase
{
   ...
   public void testConnectionFactorySerialization() throws Exception
   {
      ...
      HornetQConnectionFactory cf = HornetQJMSClient.createConnectionFactoryWithoutHA(JMSFactoryType.CF, new TransportConfiguration("org.apache.activemq6.core.remoting.impl.netty.NettyConnectorFactory"));
