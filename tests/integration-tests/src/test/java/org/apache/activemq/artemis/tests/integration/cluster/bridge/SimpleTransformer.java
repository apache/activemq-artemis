...
public class SimpleTransformer implements Transformer {
   ...
   public Message transform(final Message messageParameter) {
      ...
      SimpleString oldProp = (SimpleString) message.getObjectProperty(SimpleString.toSimpleString("wibble"));

      if (!oldProp.equals(SimpleString.toSimpleString("bing"))) {
         throw new IllegalStateException("Wrong property value!!");
      }

      // Change a property
      message.putStringProperty(SimpleString.toSimpleString("wibble"), SimpleString.toSimpleString("bong"));
