...
public class MQTTSecurityCRLTest extends ActiveMQTestBase {
   ...
   protected Configuration createConfiguration(String name) throws Exception {
      ...
      configuration.setPagingDirectory(getTestDir() + "/" + name + "/" + configuration.getPagingDirectory());
      configuration.setLargeMessagesDirectory(getTestDir() + "/" + name + "/" + configuration.getLargeMessagesDirectory());
      configuration.setJournalDirectory(getTestDir() + "/" + name + "/" + configuration.getJournalDirectory());
      configuration.setBindingsDirectory(getTestDir() + "/" + name + "/" + configuration.getBindingsDirectory());
