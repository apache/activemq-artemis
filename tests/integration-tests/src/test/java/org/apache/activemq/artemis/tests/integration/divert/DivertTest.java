...
public class DivertTest extends ActiveMQTestBase {
   ...
   public void testDivertToNewAddress() throws Exception {
      ...
      AddressSettings autoCreateDivertDestinationsAS = new AddressSettings().setAutoCreateDivertDestination(true);
      ...
      server.getConfiguration().addAddressSetting(queueName + ".#", autoCreateDivertDestinationsAS);
      ...
      message = session.createMessage(true);
      message.putStringProperty(propKey, noDivertAutoCreateQName);
      producer.send(message);
      producer.close();
