...
public class MessageRedistributionTest extends ClusterTestBase {
   ...
   public static Collection<MessageLoadBalancingType[]> getParams() {
      return Arrays.asList(new MessageLoadBalancingType[][] {{MessageLoadBalancingType.ON_DEMAND}, {MessageLoadBalancingType.OFF_WITH_REDISTRIBUTION}, {MessageLoadBalancingType.STRICT_WITH_REDISTRIBUTION}});
   }
