...
public class JMSBridgeReconnectionTest extends BridgeTestBase {
   ...
   public void performCrashDestinationStopBridge() throws Exception {
      ...
      final JMSBridgeImpl bridge = new JMSBridgeImpl("JMS_BRDIGE_NAME", factInUse0, factInUse1, sourceQueueFactory, targetQueueFactory, null, null, null, null, null, 1000, -1, QualityOfServiceMode.DUPLICATES_OK, 10, -1, null, null, false);
