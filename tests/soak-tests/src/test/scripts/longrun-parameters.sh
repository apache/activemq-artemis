...
export TEST_LARGE_ACCUMULATION_AMQP_CREDITS=5000
export TEST_LARGE_ACCUMULATION_MAX_PENDING_ACKS=200000
...
export TEST_LARGE_ACCUMULATION_NUMBER_OF_LARGE_MESSAGES=500
export TEST_LARGE_ACCUMULATION_SIZE_OF_LARGE_MESSAGE=200000
export TEST_LARGE_ACCUMULATION_NUMBER_OF_REGULAR_MESSAGES=1000
export TEST_LARGE_ACCUMULATION_SIZE_OF_REGULAR_MESSAGE=30000
export TEST_LARGE_ACCUMULATION_NUMBER_OF_REBOOTS_FIRST_PHASE=5
export TEST_LARGE_ACCUMULATION_LARGE_TIMEOUT_MINUTES=120
export TEST_LARGE_ACCUMULATION_TIMEOUT_LOOP_REBOOT_PHASE2=20000
