...
public class HttpHeaderProperty {
   ...
   public static final String JMS_PROPERTY_DISCRIMINATOR  = "jms.property.";

   /**
    * Either strips the prefix "jms.property." and returns the rest of the name or (if not starting with aforementioned prefix)
   ...
   public static String toPropertyName(String httpHeader) {
      if (httpHeader.startsWith( JMS_PROPERTY_DISCRIMINATOR )) {
         return httpHeader.replaceAll( JMS_PROPERTY_DISCRIMINATOR, "" );
      } else {
