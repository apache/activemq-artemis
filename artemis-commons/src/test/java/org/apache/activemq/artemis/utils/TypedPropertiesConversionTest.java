...
public class TypedPropertiesConversionTest {
   ...
   private final SimpleString unknownKey = SimpleString.toSimpleString("this.key.is.never.used");
   ...
   public void testBooleanProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Boolean.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Boolean.toString(val)));
      Assert.assertEquals(val, props.getBooleanProperty(key));
   ...
   public void testCharProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Character.toString(val)), props.getSimpleStringProperty(key));
   ...
   public void testByteProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Byte.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Byte.toString(val)));
      Assert.assertEquals(val, props.getByteProperty(key));
   ...
   public void testIntProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Integer.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Integer.toString(val)));
      Assert.assertEquals(val, props.getIntProperty(key));
   ...
   public void testLongProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Long.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Long.toString(val)));
      Assert.assertEquals(val, props.getLongProperty(key));
   ...
   public void testDoubleProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Double.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Double.toString(val)));
      Assert.assertEquals(val, props.getDoubleProperty(key));
   ...
   public void testFloatProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Float.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Float.toString(val)));
      Assert.assertEquals(val, props.getFloatProperty(key));
   ...
   public void testShortProperty() throws Exception {
      ...
      Assert.assertEquals(SimpleString.toSimpleString(Short.toString(val)), props.getSimpleStringProperty(key));

      props.putSimpleStringProperty(key, SimpleString.toSimpleString(Short.toString(val)));
      Assert.assertEquals(val, props.getShortProperty(key));
