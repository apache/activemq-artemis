 ...
 */
package org.apache.activemq.artemis.securitymanager;
...
/**
 * This strategy combines the functionality of the {@link org.apache.kafka.common.internals.LegacyStrategy}, {@link org.apache.kafka.common.internals.ModernStrategy}, and
 * {@link org.apache.kafka.common.internals.UnsupportedStrategy} strategies to provide the legacy APIs as long as they are present and not degraded.
...
class CompositeStrategy implements SecurityManagerCompatibility {
   ...
   public <T> T doPrivileged(PrivilegedExceptionAction<T> action) throws PrivilegedActionException {
      return performAction(compatibility -> {
         try {
            return compatibility.doPrivileged(action);
         } catch (Exception e) {
   ...
   public boolean isEnabled() {
      return performAction(SecurityManagerCompatibility::isEnabled);
   }

   private static <E extends Throwable, R> R throwAsUnchecked(Throwable t) throws E {
      throw (E) t;
   }
}
