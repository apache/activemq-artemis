...
public class ProxyProtocolUtil {
   ...
   public static final AttributeKey<String> PROXY_PROTOCOL_SOURCE_PORT = AttributeKey.valueOf("proxyProtocolSourcePort");
   ...
   public static final AttributeKey<String> PROXY_PROTOCOL_DESTINATION_PORT = AttributeKey.valueOf("proxyProtocolDestinationPort");
