...
import static org.apache.activemq.artemis.quorum.etcd.EtcdDistributedPrimitiveManager.PrimitiveType.validatePrimitiveInstance;

public abstract class EtcdDistributedPrimitive implements AutoCloseable {

   // this is used to prevent deadlocks on close
   protected final EtcdDistributedPrimitiveManager manager;
   private final PrimitiveId id;

   private boolean unavailable;
   private boolean closed;

   protected EtcdDistributedPrimitive(PrimitiveId id, EtcdDistributedPrimitiveManager manager) {
      this.id = id;
