...
public interface ActiveMQServerControl {
   ...
   String REPLICA_SYNC_DESCRIPTION = "Whether the initial replication synchronization process with the backup server is complete";
   String IS_ACTIVE_DESCRIPTION = "Server is active";
