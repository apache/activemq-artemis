   ...
   public static synchronized ThreadPoolExecutor getGlobalThreadPool() {
      if (globalThreadPool == null) {
         ...
         if (globalThreadMaxPoolSize == -1) {
            ...
            globalThreadPool = new ThreadPoolExecutor(ActiveMQClient.globalThreadMaxPoolSize, ActiveMQClient.globalThreadMaxPoolSize, 0L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), factory);
         }
      }
