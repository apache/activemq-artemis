...
public interface CompositeDataConstants {
   ...
   String TEXT_DESCR = "textDescr";
   String TEXT_BODY = "textBody";
   String HEX_DESCR = "hexDescr";
   String DECIMAL_DESCR = "decimalDescr";
   String BYTES_BODY = "bytesBody";
   String AMQP_DESCR = "amqpDescr";
   String AMQP_BODY = "amqpBody";
   String LARGE_DESCR = "largeDescr";
   String LARGE_BODY = "largeBody";
   String COMPRESSED_DESCR = "compressedDescr";
   String COMPRESSED_BODY = "compressedBody";
