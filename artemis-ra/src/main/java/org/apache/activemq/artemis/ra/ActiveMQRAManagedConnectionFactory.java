...
public final class ActiveMQRAManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation {
   ...
   /**
    * Used to configure whether the connection should be part of the JTA TX. This is when the RA doesn not have access to the
    * Transaction manager to deduct whether this is the case.
    */
    ...
    *            Thrown if a connection factory can't be created
    */
   @Override
    ...
    * @throws ResourceException
    *            Thrown if a managed connection can't be created
    */
   @Override
   public ManagedConnection createManagedConnection(final Subject subject, final ConnectionRequestInfo cxRequestInfo)
      ...
      ActiveMQRAManagedConnection mc = new ActiveMQRAManagedConnection(this, cri, ra, credential.getUserName(),
    ...
    * @return The managed connection
    * @throws ResourceException
    *            Thrown if the managed connection can not be found
    */
   @Override
   public ManagedConnection matchManagedConnections(final Set connectionSet, final Subject subject,
      ...
      for (Object obj : connectionSet) {
         if (obj instanceof ActiveMQRAManagedConnection) {
            ...
            if ((mc.getUserName() == null || mc.getUserName() != null && mc.getUserName().equals(credential.getUserName()))
                     && mcf.equals(this)) {
    ...
    *           The writer
    * @throws ResourceException
    *            Thrown if the writer can't be set
    */
   @Override
    ...
    * @return The writer
    * @throws ResourceException
    *            Thrown if the writer can't be retrieved
    */
   @Override
   ...
   public void setInJtaTransaction(final Boolean inJtaTransaction) {
    ...
    *
    * @param info
    *           The instance that should be updated; may be <code>null</code>
    * @return The instance
    */
